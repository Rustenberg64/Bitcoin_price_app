...
const client = new bitcoin_proto.SearchPrice(target,grpc.credentials.createInsecure());
...
const getDatabygRPC = async ({ place, date_from, date_to, interval }: params1) => {
  ...
  let params = { place, date_from, date_to, interval };
  let res;
  await client.getPrices(params, (err:any, response:any) => {
